      ...
      >
            ...
            >
              <div className="flex flex-col items-center space-y-2">
                <Cake className={`w-8 h-8 ${
                  formData.category === 'birthday' ? 'text-blue-400' : 'text-zinc-400'
                }`} />
                <span className={`font-semibold ${
                  formData.category === 'birthday' ? 'text-blue-300' : 'text-zinc-300'
                }`}>
                  Birthday Card
                </span>
                {formData.category === 'birthday' && (
            ...
            >
              <div className="flex flex-col items-center space-y-2">
                <Heart className={`w-8 h-8 ${
                  formData.category === 'proposal' ? 'text-pink-400' : 'text-zinc-400'
                }`} />
                <span className={`font-semibold ${
                  formData.category === 'proposal' ? 'text-pink-300' : 'text-zinc-300'
                }`}>
                  Proposal Card
                </span>
                {formData.category === 'proposal' && (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <motion.button
            ...
            className={`w-full group relative overflow-hidden text-white py-4 rounded-xl font-semibold text-lg disabled:opacity-50 disabled:cursor-not-allowed ${
              formData.category === 'birthday'
